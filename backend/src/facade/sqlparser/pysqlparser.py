...
keywords = {
    k: CaselessKeyword(k)
    for k in """\
    INSERT INTO EXECUTE IMMEDIATE CREATE TABLE AS VIEW PROCEDURE IF EXITS FOR UNION ALL AND INTERSECT EXCEPT COLLATE ASC DESC ON USING NATURAL INNER CROSS LEFT OUTER JOIN AS INDEXED NOT
