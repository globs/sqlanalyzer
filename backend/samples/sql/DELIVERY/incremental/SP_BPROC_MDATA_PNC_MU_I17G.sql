CREATE OR REPLACE PROCEDURE SP_BUSINESS_PROCESS_MDATA_PNC_MU_I17G () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS (BUSINESS_PROCESS_ID, BUSINESS_PROCESS_NAME, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE)
	VALUES(VAR_BUSINESS_PROCESS_ID_01, 'Business Process for P&C Manual Upload of Data', 'I17G', 'CLOSING', 'POSTING');
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_PNC_EXPENSE_RATIO', 'I17G', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_PNC_RISK_ADJUSTMENT', 'I17G', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_PNC_RISK_ADJUSTMENT_FORPLAN', 'I17G', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
