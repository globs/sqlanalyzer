CREATE OR REPLACE PROCEDURE SP_BUSINESS_PROCESS_MDATA_LRM_DIP_I17L () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS (BUSINESS_PROCESS_ID, BUSINESS_PROCESS_NAME, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE)
	VALUES(VAR_BUSINESS_PROCESS_ID_01, 'Business Process for data flow between LRM and DIP Systems', 'I17L', 'CLOSING', 'POSTING');
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_RAP_LRM_TO_DIP', 'I17L', 'CLOSING', 'POSTING', true, 'External System Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_DIP_TO_LRM', 'I17L', 'CLOSING', 'POSTING', true, 'External System Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_LIFE_RISK_ADJUSTMENT', 'I17L', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
