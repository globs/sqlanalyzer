CREATE OR REPLACE PROCEDURE SP_ORCHESTRATION_PROCESS_METADATA_AUS_NZ_MOD () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS_STEP (BUSINESS_PROCESS_STEP_ID, BUSINESS_PROCESS_STEP_NAME, BUSINESS_PROCESS_ID, STEP_SEQUENCE)
	VALUES(VAR_BUSINESS_PROCESS_STEP_ID_01, 'AUS-NZ (APAC) Modeling Engine to RDWH (DIP) Data Flow', VAR_BUSINESS_PROCESS_ID_01, 3);
...
(VAR_ORCHESTRATION_PROCESS_ID, 'AUS-NZ (APAC) Modeling Engine to DIP', 'AUS-NZ (APAC) Modeling Engine to DIP Data Flow', null);
...
(VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process AUS-NZ (APAC) CF in Staging',VAR_BATCH_ID,NULL, true, false);
...
(VAR_BATCH_ID,'Talend AUS-NZ (APAC) Staging Process','Talend AUS-NZ (APAC) Staging Process','TALEND', 1, NULL, NULL, '[POST-COMPLETION]api-dip:checkIpdsAutoTrigger');


INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID) VALUES
(VAR_JOB_GROUP_ID,'Talend AUS-NZ (APAC) Staging Process Job Group',VAR_BATCH_ID,NULL);


INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend AUS-NZ (APAC) Staging Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL );
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 2, VAR_JOB_ID, 'AUS-NZ (APAC) Staging Load Step ', 1, NULL, 'api-dip:uploadinsert','api-diptalend:north_asia_cashflow_staging_load',NULL);
...
INSERT INTO BATCH_GROUPING (BATCH_GROUPING_ID, BATCH_GROUPING_NAME, ACTIVE_DWH, PASSIVE_DWH, LAST_UPDATE_TIME)
		VALUES(VAR_BATCH_GROUPING_ID, 'AUS-NZ (APAC) RDWH STAGING PROCESSING', 'DWHD2_' || chr(36) || '{ENV}', 'DWHD1_' || chr(36) || '{ENV}', CURRENT_TIMESTAMP);

INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_INGEST_ANZ_CASHFLOWS_FOR_VALIDATION', 'Event for AUS-NZ (APAC) Staging Load' );
...
INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_INGEST_ANZ_CASHFLOWS_FOR_VALIDATION', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID, VAR_BATCH_GROUPING_ID, FALSE);
...
INSERT INTO ORCHESTRATION_PROCESS_STEP (ORCHESTRATION_PROCESS_STEP_ID,ORCHESTRATION_PROCESS_ID,ORCHESTRATION_PROCESS_STEP_NAME,CHILD_BATCH_ID,TRIGGER_DEPENDENT_STEPS, STARTING_STEP, OPTIONAL_RUN) 
	VALUES (VAR_ORCHESTRATION_PROCESS_STEP1_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process AUS-NZ (APAC) CF in RDWH', VAR_BATCH_ID, NULL, false, false);
...
INSERT INTO BATCH (BATCH_ID,BATCH_NAME,BATCH_DESCRIPTION,APPLICATION_NAME,BATCH_PRIORITY,ON_ERROR,PRE_BATCH_PROCESSING,POST_BATCH_PROCESSING) VALUES
	(VAR_BATCH_ID,'Talend AUS-NZ (APAC) DWH Process','Talend AUS-NZ (APAC) DWH Process','TALEND', 1,NULL,NULL,NULL);

INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID) VALUES
	(VAR_JOB_GROUP_ID,'Talend AUS-NZ (APAC) DWH Process Job Group',VAR_BATCH_ID,NULL);

INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend AUS-NZ (APAC) DWH Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL);


SET VAR_STEP = NEXT VALUE FOR SEQUENCE_BATCH_METADATA;

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 3, VAR_JOB_ID, 'INSERT AUS-NZ (APAC) CF in RDWH', 1, NULL, 'api-dip:uploadupdate','api-diptalend:rdwh_historization_job',NULL);
...
INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_ANZ_CASHFLOWS_VALIDATED', 'Event to Process AUS-NZ (APAC) CF in RDWH' );

INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_ANZ_CASHFLOWS_VALIDATED', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP1_ID, NULL, VAR_BATCH_GROUPING_ID, TRUE);
