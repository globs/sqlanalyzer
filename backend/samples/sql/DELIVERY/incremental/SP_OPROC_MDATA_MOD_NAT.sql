CREATE OR REPLACE PROCEDURE SP_ORCHESTRATION_PROCESS_METADATA_MOD_NAT () RETURNS INTEGER
...
(VAR_BATCH_ID,'Talend North Asia (APAC) Staging Process','Talend North Asia (APAC) Staging Process','TALEND', 1, NULL
, NULL, '[POST-COMPLETION]api-dip:checkIpdsAutoTrigger');
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 2, VAR_JOB_ID, 'North Asia (APAC) Staging Load Step ', 1, NULL, 'api-dip:uploadinsert'
		,'api-diptalend:north_asia_cashflow_staging_load', NULL);
...
, DELIMITER, CONVERTED_STAGING_TABLE_NAME, CHECK_DUPLICATES, SPECIFIC_PROCESS, DATA_FILE_TREATMENT, REGIONAL_DATA, FILE_DIRECTORY, FILE_NAME_PATTERN ) 
        VALUES ( VAR_STEP, 'STAGING_' || chr(36) || '{ENV}', 'STAGING_NAT_PROJECTIONS', 0, 0, 0, '~', NULL, 0, NULL, NULL, 0, NULL, NULL );
...
INSERT INTO BATCH_GROUPING (BATCH_GROUPING_ID, BATCH_GROUPING_NAME, ACTIVE_DWH, PASSIVE_DWH, LAST_UPDATE_TIME)
		VALUES(VAR_BATCH_GROUPING_ID, 'North Asia (APAC) RDWH STAGING PROCESSING', 'DWHD2_' || chr(36) || '{ENV}'
		, 'DWHD1_' || chr(36) || '{ENV}', CURRENT_TIMESTAMP);
...
INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_INGEST_NAT_CASHFLOWS_FOR_VALIDATION', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID
...
INSERT INTO BATCH (BATCH_ID,BATCH_NAME,BATCH_DESCRIPTION,APPLICATION_NAME,BATCH_PRIORITY,ON_ERROR,PRE_BATCH_PROCESSING,POST_BATCH_PROCESSING) VALUES
	(VAR_BATCH_ID,'Talend North Asia (APAC) DWH Process','Talend North Asia (APAC) DWH Process','TALEND', 1,NULL,NULL,'api-dip:postIpdsProcessing');
...
INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_NAT_CASHFLOWS_VALIDATED', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP1_ID, NULL, VAR_BATCH_GROUPING_ID_02, TRUE);
