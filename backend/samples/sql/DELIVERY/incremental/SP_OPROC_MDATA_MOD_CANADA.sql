CREATE OR REPLACE PROCEDURE SP_ORCHESTRATION_PROCESS_METADATA_MOD_CANADA () RETURNS INTEGER
...
(VAR_ORCHESTRATION_PROCESS_ID,'CANADA Modeling Engine to DIP','CANADA Modeling Engine to DIP Data Flow', null);
...
(VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process CANADA CF in Staging',VAR_BATCH_ID,NULL, true, false);
...
(VAR_BATCH_ID,'Talend CANADA Staging Process','Talend CANADA Staging Process','TALEND', 1, NULL, NULL, '[POST-COMPLETION]api-dip:checkIpdsAutoTrigger');

INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID) VALUES
(VAR_JOB_GROUP_ID,'Talend CANADA Staging Process Job Group',VAR_BATCH_ID,NULL);

INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend CANADA Staging Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL );
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 2, VAR_JOB_ID, 'CANADA Staging Load Step ', 1, NULL, 'api-dip:uploadinsert','api-diptalend:canada_cashflow_staging_load',NULL);
...
, DELIMITER, CONVERTED_STAGING_TABLE_NAME, CHECK_DUPLICATES, SPECIFIC_PROCESS, DATA_FILE_TREATMENT, REGIONAL_DATA, FILE_DIRECTORY, FILE_NAME_PATTERN ) 
        VALUES ( VAR_STEP, 'STAGING_' || chr(36) || '{ENV}', 'WRK_CAN_AXIS_PROJECTIONS_DYNAMIC', 0, 0, 0, '~', NULL, 0, NULL, NULL, 0, NULL, NULL );
...
INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_INGEST_CANADA_CASHFLOWS_FOR_VALIDATION', 'Event for CANADA Staging Load' );
...
INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_INGEST_CANADA_CASHFLOWS_FOR_VALIDATION', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP_ID
		, VAR_ORCHESTRATION_PROCESS_ID, VAR_BATCH_GROUPING_ID, FALSE);
...
,CHILD_BATCH_ID,TRIGGER_DEPENDENT_STEPS, STARTING_STEP, OPTIONAL_RUN) 
	VALUES (VAR_ORCHESTRATION_PROCESS_STEP1_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process CANADA CF in RDWH', VAR_BATCH_ID, NULL, false, false);
...
INSERT INTO BATCH (BATCH_ID,BATCH_NAME,BATCH_DESCRIPTION,APPLICATION_NAME,BATCH_PRIORITY,ON_ERROR,PRE_BATCH_PROCESSING,POST_BATCH_PROCESSING) VALUES
	(VAR_BATCH_ID,'Talend CANADA DWH Process','Talend CANADA DWH Process','TALEND', 1,NULL,NULL,'api-dip:postIpdsProcessing');

INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID) VALUES
	(VAR_JOB_GROUP_ID,'Talend CANADA DWH Process Job Group',VAR_BATCH_ID,NULL);

INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend CANADA DWH Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL);


SET VAR_STEP = NEXT VALUE FOR SEQUENCE_BATCH_METADATA;

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 3, VAR_JOB_ID, 'INSERT Canada CF in RDWH', 1, NULL, 'api-dip:uploadupdate','api-diptalend:canada_cashflow_dwh_load',NULL);
...
INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_CANADA_CASHFLOWS_VALIDATED', 'Event to Process CANADA CF in RDWH' );

INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_CANADA_CASHFLOWS_VALIDATED', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP1_ID, NULL, VAR_BATCH_GROUPING_ID_02, TRUE);
