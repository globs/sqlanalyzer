CREATE OR REPLACE PROCEDURE SP_BUSINESS_PROCESS_MDATA_SAS_OMEGA_I17L () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS (BUSINESS_PROCESS_ID, BUSINESS_PROCESS_NAME, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE)
	VALUES(VAR_BUSINESS_PROCESS_ID_01, 'Business Process for DIP to SAS to DIP and to Omega and BPE Data Flow', 'I17L', 'CLOSING', 'POSTING');
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_DIP_TO_SAS_DATA', 'I17L', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);

INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_02, 'EVT_SAS_TO_DIP_RESULTS', 'I17L', 'CLOSING', 'POSTING', true, 'External System Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_DIP_TO_OMEGA_RUN_FOR_SAS_RESULTS', 'I17L', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_DIP_TO_BPE_FOR_SAS_RESULTS', 'I17L', 'CLOSING', 'POSTING', true, 'External System Triggered', NULL);
