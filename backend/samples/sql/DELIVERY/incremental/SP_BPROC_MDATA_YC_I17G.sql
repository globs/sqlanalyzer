CREATE OR REPLACE PROCEDURE SP_BUSINESS_PROCESS_MDATA_YIELD_CURVE_I17G () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS (BUSINESS_PROCESS_ID, BUSINESS_PROCESS_NAME, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE)
	VALUES(VAR_BUSINESS_PROCESS_ID_01, 'Business Process for Yield Curve Data Flow', 'I17G', 'CLOSING', 'POSTING');
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_LIFE_ECONOMIC_CURVE', 'I17G', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
