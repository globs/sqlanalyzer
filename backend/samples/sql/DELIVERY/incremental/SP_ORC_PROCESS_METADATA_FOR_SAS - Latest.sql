...
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_01, NULL, NULL, NULL, NULL, chr(36) || '{DWH_DB}.IFRS17_CSM_TRT_CHARACS(''' || chr(36) || '{CLOSING_PERIOD}'', ''' || chr(36) || '{CLOSING_DATE}'', ''' || chr(36) || '{DWH_DB}'', ''BI_' || chr(36) || '{ENV}'', ''' || chr(36) || '{SCENARIO_TYPE_ID}'', ''' || chr(36) || '{SAS_ENTITY}'', ''' || chr(36) || '{CLOSING_TYPE}'', ''' || chr(36) || '{DIP_RUN_ID}'', ''' || chr(36) || '{INTERVAL}'')', NULL, NULL, NULL);

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_02, 4, VAR_JOB_ID_01, 'Assumed Treaty - Data extraction', 2, NULL, NULL, 'binary-dip:dbsql-query-explicit', NULL);
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_02, NULL, NULL, '~', true, 'SELECT ROW_NUMBER() OVER() AS ROW_ID, REPORTING_DT, SCENARIO_ID, ENTITY_ID, LEGALENTITY_CF, LEGALENTITY_LL, PARTLEGENTITY_CF, PARTLEGENTITY_LL, LEBRANCH_CF, LEBRANCH_LL, PARTLEBRANCH_CF, PARTLEBRANCH_LL, PRDSIT_CF, SSD_CF, SSD_LS, ESB_CF, ESB_LS, CTR_NF, CTRPCPNAM_LL, SEC_NF, SECLAB_LM, UOA_CUR, TRT_CUR, PCPCUR_CF, SSDCUR_CF, UOA_NAME, PROFIT_SIGN, PROFIT_SIGN_FLG, PROFIT_LVL, SEG_CODE, SEG_LS, LOB_CF, LOB_HS, LIFPRDLIN_CF, LIFPRDLIN_LL, LIFLOB_CF, LIFLOB_LL, USGAAP_CT, USGAAP_CT_LB, BUSUNIT_CF, BUSUNIT_LM, MRKUNT_NT, MRKUNT_LS, SUBMRK_NT, SUBMRK_LS, CR_NF, CR_LM, ANNUAL_COHORT, FRSSECUWY_NF, CTRUWY_NF, SECUWY_NF, CTRINC_D, SECINC_D, CTRFRSINC_D, SECFRSINC_D, CTRFRSPAYM_D, SECFRSPAYM_D, FRSPRICONER_D, TERM_D, CANCTR_D, SECCAN_D, CTRNEW_CT, RETFLG_CF, INTOPEFL_CF, TERMPERM_CF, NEWORMODIF_CF, MODTYP_CF, SECSTS_CT, SECSTS_LS, ACCADMTYP_CT, SECACCSTS_CT, SECACCSTS_LS, NAT_CF, NAT_GD, ACCFRQ_CT, LIFTRTTYP_CF, LIFTRTTYP_LS, RETROTYP_CF, RETRO_RA_LO_CF, RENTYP_CT, CTROLDNBR_LM, PARSEC_NF, ESTCRB_CT, INSURANCE_CONTRACT_GROUP_ID, RATEINDEX_CT, COV_RTO, COC_RTO, X_DIM_RETRO_PATH_ID, INTERNAL_RETRO_FLG, TRANSITION_APPROACH_CD, TRANSITION_FLG, TRANSITION_LOCKINDATE, TRANSITION_INPUT_CSM_AMT, DIRECT_TRANSITION_ACQ_COSTS_AMT, NPR_DEFAULT_INI_RAT, NPR_DEFAULT_CURRENT_RAT, NPR_RECOVERY_INI_RAT, NPR_RECOVERY_CURRENT_RAT, NPR_CALCULATION_FLG, EXP_ADJ_PREM_CSM_ALLOC_RAT, EXP_ADJ_RCOM_CSM_ALLOC_RAT, EXP_ADJ_NDIC_CSM_ALLOC_RAT, RUN_ID, NORM_CD, "INTERVAL", ASOFDAY FROM ' || chr(36) || '{DWH_DB}.TCSM_TRT_CHARACS WHERE REPORTING_DT = VARCHAR_FORMAT(''' || chr(36) || '{CLOSING_DATE}'' , ''DD/MM/YYYY'') AND CLOSING_QUARTER_CODE = ''' || chr(36) || '{CLOSING_PERIOD}'' AND SCENARIO_ID = ''' || chr(36) || '{SCENARIO_TYPE_ID}'' AND ENTITY_ID = ''' || chr(36) || '{SAS_ENTITY}'' AND RUN_ID = ''' || chr(36) || '{DIP_RUN_ID}'' AND NORM_CD  = ''' || chr(36) || '{CLOSING_TYPE}'' AND INTERVAL =''' || chr(36) || '{INTERVAL}'' ORDER BY ROW_ID', 'csm/out'
...
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_01, NULL, NULL, NULL, NULL, chr(36) || '{DWH_DB}.IFRS17_CSM_QUOTES(''' || chr(36) || '{CLOSING_PERIOD}'', ''' || chr(36) || '{CLOSING_DATE}'', ''' || chr(36) || '{DWH_DB}'', ''BI_' || chr(36) || '{ENV}'', ''' || chr(36) || '{RATE_TYPE}'', ''' || chr(36) || '{SCENARIO_TYPE_ID}'', ''' || chr(36) || '{SAS_ENTITY}'', ''' || chr(36) || '{CLOSING_TYPE}'', ''' || chr(36) || '{DIP_RUN_ID}'')', NULL, NULL, NULL);

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_02, 4, VAR_JOB_ID_02, 'Quotes - Data extraction', 2, NULL, NULL, 'binary-dip:dbsql-query-explicit', NULL);
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_02, NULL, NULL, '~', true, 'SELECT ROW_NUMBER() OVER() AS ROW_ID, SCENARIO_ID, QUOTE_DT, QUOTE_ID, MATURITY_DT, QUOTE_RT, RISK_FACTOR_CATEGORY_CD, ENTITY_ID, CURRENCY_CD, RATEINDEX_CT, NORM_CD, RUN_ID, ASOFDAY FROM ' || chr(36) || '{DWH_DB}.TCSM_QUOTES WHERE REPORTING_DT = VARCHAR_FORMAT(''' || chr(36) || '{CLOSING_DATE}'' , ''DD/MM/YYYY'') AND CLOSING_QUARTER_CODE = ''' || chr(36) || '{CLOSING_PERIOD}'' AND SCENARIO_ID = ''' || chr(36) || '{SCENARIO_TYPE_ID}'' AND ENTITY_ID = ''' || chr(36) || '{SAS_ENTITY}'' AND RUN_ID   = ''' || chr(36) || '{DIP_RUN_ID}'' AND NORM_CD  = ''' || chr(36) || '{CLOSING_TYPE}'' ORDER BY ROW_ID', 'csm/out'
...
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_01, NULL, NULL, NULL, NULL, chr(36) || '{DWH_DB}.IFRS17_CSM_PROJECTED_CASHFLOW_DTM(''' || chr(36) || '{CLOSING_PERIOD}'', ''' || chr(36) || '{CLOSING_DATE}'', ''' || chr(36) || '{DWH_DB}'', ''BI_' || chr(36) || '{ENV}'', ''' || chr(36) || '{SCENARIO_TYPE_ID}'', ''' || chr(36) || '{SAS_ENTITY}'', ''' || chr(36) || '{CLOSING_TYPE}'', ''' || chr(36) || '{DIP_RUN_ID}'', ''' || chr(36) || '{INTERVAL}'')', NULL, NULL, NULL);
...
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
		VALUES(VAR_STEP_01, NULL, NULL, NULL, NULL, chr(36) || '{DWH_DB}.IFRS17_CSM_IR_DRIVER_DTM(''' || chr(36) || '{CLOSING_PERIOD}'', ''' || chr(36) || '{CLOSING_DATE}'', ''' || chr(36) || '{DWH_DB}'', ''BI_' || chr(36) || '{ENV}'', ''' || chr(36) || '{SCENARIO_TYPE_ID}'', ''' || chr(36) || '{SAS_ENTITY}'', ''' || chr(36) || '{CLOSING_TYPE}'', ''' || chr(36) || '{DIP_RUN_ID}'', ''' || chr(36) || '{INTERVAL}'')', NULL, NULL, NULL);
...
INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN, INSTANCE_TYPE)
        VALUES ( VAR_JOB_ID_02, 'Process AE from SAS to DIP', NULL, VAR_JOB_GROUP_ID_01, NULL, NULL, 'MULTI');
INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN, INSTANCE_TYPE)
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_02, 2, VAR_JOB_ID_02, 'AE Staging load step', 2, NULL, NULL, 'binary-dip:dbload-file', NULL);
...
INSERT INTO DELIVERY_DEV.DATA_VALIDATION_CONTROL (DATA_VALIDATION_CONTROL_ID, CONTROL_NAME, CONTROL_PROCESSING, SPECIFIC_PROCESS) 
...
INSERT INTO DELIVERY_DEV.DATA_VALIDATION_CONTROL_MAPPING (DATA_VALIDATION_CONTROL_MAPPING_ID, BATCH_ID, JOB_GROUP_ID, JOB_ID, STEP_ID
, DATA_VALIDATION_CONTROL_ID, IS_ACTIVE, CONTROL_TYPE, CONTROL_CHRONOLOGY, CONTROL_SEQUENCE, PARAMETER_NAMES) 
	VALUES(VAR_DATA_VALIDATION_CONTROL_MAPPING_ID, VAR_BATCH_ID, VAR_JOB_GROUP_ID_01, VAR_JOB_ID_02, VAR_STEP_02
	, VAR_DATA_VALIDATION_CONTROL_ID, TRUE, 'INFO', 'POST-POST', 1, NULL);


INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_03, 2, VAR_JOB_ID_02, 'AE Staging Processing for DIP step', 3, NULL, NULL, 'db-dip:sp-explicit', NULL);
INSERT INTO STAGING_LOAD_STEP (STEP_ID, STAGING_SCHEMA_NAME, STAGING_TABLE_NAME, TRUNCATE_STAGING_TABLE, MANDATORY_FILE, FILE_HEADER_ROWS, DELIMITER
, CONVERTED_STAGING_TABLE_NAME, CHECK_DUPLICATES, SPECIFIC_PROCESS, DATA_FILE_TREATMENT, REGIONAL_DATA, FILE_DIRECTORY, FILE_NAME_PATTERN)
		VALUES(VAR_STEP_03, NULL, NULL, false, false, NULL, NULL, NULL, false
		, 'STAGING_' || chr(36) || '{ENV}.SP_LOAD_SAS_TCSM_MICRO_AOC(''' || chr(36) || '{UPLOAD_REQUEST_ID}'', ''' || chr(36) || '{E}_ESIJ0790_AE_' || chr(36) || '{SSD_AE}_' || chr(36) || '{ESB_AE}_CSMENGINE_' || chr(36) || '{TIMESTAMP}.dat'', ''' || chr(36) || '{AS_OF_DATE}'', ''STAGING_' || chr(36) || '{ENV}'', ''' || chr(36) || '{DWH_DB}'',''BI_' || chr(36) || '{ENV}'')'
		, NULL, false, NULL, NULL);

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_04, 2, VAR_JOB_ID_02, 'AE Staging Processing for Omega step', 4, NULL, NULL, 'db-dip:sp-explicit', NULL);
INSERT INTO STAGING_LOAD_STEP (STEP_ID, STAGING_SCHEMA_NAME, STAGING_TABLE_NAME, TRUNCATE_STAGING_TABLE, MANDATORY_FILE, FILE_HEADER_ROWS, DELIMITER
, CONVERTED_STAGING_TABLE_NAME, CHECK_DUPLICATES, SPECIFIC_PROCESS, DATA_FILE_TREATMENT, REGIONAL_DATA, FILE_DIRECTORY, FILE_NAME_PATTERN)
		VALUES(VAR_STEP_04, NULL, NULL, false, false, NULL, NULL, NULL, false
		, 'STAGING_DEV.SP_LOAD_WRK_TCSM_MACRO_AOC_TO_OMEGA(''' || chr(36) || '{CLOSING_PERIOD}'', ''' || chr(36) || '{AS_OF_DATE}'', ''STAGING_' || chr(36) || '{ENV}'', ''' || chr(36) || '{DWH_DB}'',''BI_' || chr(36) || '{ENV}'')'
		, NULL, false, NULL, NULL);
		

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING, STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_05, 3, VAR_JOB_ID_02, 'Omega AE Historization Step', 5, NULL, NULL, 'db-dip:sp-explicit', NULL);
...
INSERT INTO DELIVERY_DEV.DATA_VALIDATION_CONTROL_MAPPING (DATA_VALIDATION_CONTROL_MAPPING_ID, BATCH_ID, JOB_GROUP_ID, JOB_ID, STEP_ID
, DATA_VALIDATION_CONTROL_ID, IS_ACTIVE, CONTROL_TYPE, CONTROL_CHRONOLOGY, CONTROL_SEQUENCE, PARAMETER_NAMES) 
	VALUES(VAR_DATA_VALIDATION_CONTROL_MAPPING_ID, VAR_BATCH_ID, VAR_JOB_GROUP_ID_01, VAR_JOB_ID_02, VAR_STEP_05
	, VAR_DATA_VALIDATION_CONTROL_ID, TRUE, 'INFO', 'POST-POST', 1, NULL);

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP_06, 4, VAR_JOB_ID_02, 'Omega AE - Data extraction', 6, NULL, NULL, 'binary-dip:dbsql-query-explicit', NULL);
INSERT INTO DATA_EXPOSITION_STEP (STEP_ID, SCHEMA_NAME, TABLE_NAME, DELIMITER, INCLUDE_HEADER, SPECIFIC_PROCESS, FILE_DIRECTORY, FILE_NAME_PATTERN, DATA_FILE_TREATMENT)
