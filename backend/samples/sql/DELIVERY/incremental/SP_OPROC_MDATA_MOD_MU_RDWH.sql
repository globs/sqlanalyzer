CREATE OR REPLACE PROCEDURE SP_ORCHESTRATION_PROCESS_METADATA_MOD_MU_RDWH () RETURNS INTEGER
...
(VAR_ORCHESTRATION_PROCESS_ID,'RDWH MU Upload','RDWH MU Upload Data Flow', null);
...
(VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process RDWH MU Upload CF in Staging',VAR_BATCH_ID,NULL, true, false);
...
(VAR_BATCH_ID,'Talend RDWH MU Upload Staging Process','Talend RDWH MU Upload Staging Process','TALEND', 1, NULL
...
(VAR_JOB_GROUP_ID,'Talend RDWH MU Upload Staging Process Job Group',VAR_BATCH_ID,NULL);


INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend RDWH MU Upload Staging Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL );
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 2, VAR_JOB_ID, 'RDWH MU Upload Staging Load Step ', 1, NULL, 'api-dip:uploadinsert','api-diptalend:mu_cashflow_staging_load', NULL);
...
, DELIMITER, CONVERTED_STAGING_TABLE_NAME, CHECK_DUPLICATES, SPECIFIC_PROCESS, DATA_FILE_TREATMENT, REGIONAL_DATA, FILE_DIRECTORY, FILE_NAME_PATTERN ) 
        VALUES ( VAR_STEP, 'STAGING_' || chr(36) || '{ENV}', 'WRK_MANUAL_UPLOAD_DYNAMIC', 0, 0, 0, '~', NULL, 0, NULL, NULL, 0, NULL, NULL );
...
INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_INGEST_MU_CASHFLOWS_FOR_VALIDATION', 'Event for RDWH MU Upload Staging Load' );
...
INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_INGEST_MU_CASHFLOWS_FOR_VALIDATION', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP_ID, VAR_ORCHESTRATION_PROCESS_ID
...
,CHILD_BATCH_ID,TRIGGER_DEPENDENT_STEPS, STARTING_STEP, OPTIONAL_RUN) 
	VALUES (VAR_ORCHESTRATION_PROCESS_STEP1_ID, VAR_ORCHESTRATION_PROCESS_ID,'Process RDWH MU Upload CF in RDWH', VAR_BATCH_ID, NULL, false, false);
...
INSERT INTO BATCH (BATCH_ID,BATCH_NAME,BATCH_DESCRIPTION,APPLICATION_NAME,BATCH_PRIORITY,ON_ERROR,PRE_BATCH_PROCESSING,POST_BATCH_PROCESSING) VALUES
	(VAR_BATCH_ID,'Talend RDWH MU Upload DWH Process','Talend RDWH MU Upload DWH Process','TALEND', 1,NULL,NULL,'api-dip:postIpdsProcessing');

INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID) VALUES
	(VAR_JOB_GROUP_ID,'Talend RDWH MU Upload DWH Process Job Group',VAR_BATCH_ID,NULL);

INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
        VALUES ( VAR_JOB_ID, 'Talend RDWH MU Upload DWH Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL);


SET VAR_STEP = NEXT VALUE FOR SEQUENCE_BATCH_METADATA;

INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 3, VAR_JOB_ID, 'INSERT RDWH MU Upload CF in RDWH', 1, NULL, 'api-dip:uploadupdate','api-diptalend:mu_cashflow_dwh_load',NULL);
...
INSERT INTO EVENT ( EVENT_CODE, EVENT_DESCRIPTION )
        VALUES ( 'EVT_MU_CASHFLOWS_VALIDATED', 'Event to Process RDWH MU Upload CF in RDWH' );

INSERT INTO EVENT_MAPPING ( EVENT_CODE, BATCH_ID, ORCHESTRATION_PROCESS_STEP_ID, ORCHESTRATION_PROCESS_ID, BATCH_GROUPING_ID, IS_DWH_SWITCH)
        VALUES ( 'EVT_MU_CASHFLOWS_VALIDATED', VAR_BATCH_ID, VAR_ORCHESTRATION_PROCESS_STEP1_ID, NULL, VAR_BATCH_GROUPING_ID_02, TRUE);
