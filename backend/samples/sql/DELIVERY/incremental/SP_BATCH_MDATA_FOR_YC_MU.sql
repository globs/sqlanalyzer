CREATE OR REPLACE PROCEDURE SP_BATCH_METADATA_FOR_YIELD_CURVE_MU () RETURNS INTEGER
...
INSERT INTO BATCH (BATCH_ID,BATCH_NAME,BATCH_DESCRIPTION,APPLICATION_NAME,BATCH_PRIORITY,ON_ERROR,PRE_BATCH_PROCESSING,POST_BATCH_PROCESSING)
	VALUES (VAR_BATCH_ID, 'Manual Upload of Life Economic Curve', 'Manual Upload of Life Economic Curve', 'DIP', 1, NULL, NULL, NULL);

INSERT INTO JOB_GROUP (JOB_GROUP_ID,JOB_GROUP_NAME,BATCH_ID,PARENT_JOB_GROUP_ID)
	VALUES (VAR_JOB_GROUP_ID, 'Manual Upload of Life Economic Curve Job Group', VAR_BATCH_ID, NULL);

INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
	VALUES (VAR_JOB_ID, 'Manual Upload of Life Economic Curve job', NULL, VAR_JOB_GROUP_ID, NULL, NULL);
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
	VALUES (VAR_STEP, 3, VAR_JOB_ID, 'Manual Upload of Life Economic Curve Talend Processing', 1, NULL, NULL, 'api-diptalend:mu_life_ec_processing', NULL);
...
INSERT INTO JOB ( JOB_ID, JOB_NAME, JOB_PRIORITY, JOB_GROUP_ID, IS_ACTIVE, JOB_OPTIONAL_RUN )
	VALUES ( VAR_JOB_ID_01, 'Post Economic Curve MU FFX Process', NULL, VAR_JOB_GROUP_ID, NULL, NULL);
...
INSERT INTO STEP ( STEP_ID, STEP_TYPE_ID, JOB_ID, STEP_NAME, STEP_SEQUENCE ,IS_ACTIVE, PRE_STEP_PROCESSING,STEP_PROCESSING, POST_STEP_PROCESSING)
        VALUES ( VAR_STEP, 3, VAR_JOB_ID_01, 'Talend call for FFX Process of Economic Curve', 1, NULL, 'api-dip:uploadinsert'
		,'api-diptalend:mu_ffx_processing',NULL);
