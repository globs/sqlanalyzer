CREATE OR REPLACE PROCEDURE SP_BUSINESS_PROCESS_MDATA_YIELD_CURVE_I17L () RETURNS INTEGER
...
INSERT INTO BUSINESS_PROCESS (BUSINESS_PROCESS_ID, BUSINESS_PROCESS_NAME, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE)
	VALUES(VAR_BUSINESS_PROCESS_ID_01, 'Business Process for Yield Curve Data Flow', 'I17L', 'CLOSING', 'POSTING');
...
INSERT INTO BUSINESS_PROCESS_STEP (BUSINESS_PROCESS_STEP_ID, BUSINESS_PROCESS_STEP_NAME, BUSINESS_PROCESS_ID, STEP_SEQUENCE)
	VALUES(VAR_BUSINESS_PROCESS_STEP_ID_01, 'Yield Curve to DIP Data Flow', VAR_BUSINESS_PROCESS_ID_01, 1);
...
INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_INGEST_YIELD_CURVE', 'I17L', 'CLOSING', 'POSTING', true, 'External System Triggered', NULL);
...
INSERT INTO BUSINESS_PROCESS_STEP (BUSINESS_PROCESS_STEP_ID, BUSINESS_PROCESS_STEP_NAME, BUSINESS_PROCESS_ID, STEP_SEQUENCE)
	VALUES(VAR_BUSINESS_PROCESS_STEP_ID_01, 'Manual Upload of Economic Curve', VAR_BUSINESS_PROCESS_ID_01, 2);

INSERT INTO BUSINESS_EVENT (BUSINESS_EVENT_ID, EVENT_CODE, CLOSING_TYPE_CODE, SCENARIO_TYPE, RUN_TYPE, IS_ACTIVE, TRIGGER_MODE, DELAY_DAYS)
	VALUES(VAR_BUSINESS_EVENT_ID_01, 'EVT_MU_LIFE_ECONOMIC_CURVE', 'I17L', 'CLOSING', 'POSTING', true, 'DIP Triggered', NULL);
