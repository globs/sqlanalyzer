DROP PROCEDURE SP_INIT_FACTORS_SH ;

CREATE OR REPLACE PROCEDURE SP_INIT_FACTORS_SH() RETURNS INTEGER
language nzplsql
AS
BEGIN_PROC
...
BEGIN
	...
	V_CALL3_QUERY :=  'CALL STAGING_<env>.SP_LOAD_YCMS_ECONOMIC_RATE('|| P_REQUEST_ID ||', ''SHARE_<env>'', ''YCMS_OUTPUTS_FWD'', ''STAGING_<env>'', ''WRK_ECONOMIC_RATE'')';
